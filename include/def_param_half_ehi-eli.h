...
#define stepsim1 /*1000000*/  10000000 /* 100 */ /* 1000 number of simulation steps for heating under zero applied force */
#define stepsim2 /*100000000*/ 3500000000 /* 1000 */ /* 10000 LJY  can change criteria in main_*.c */
...
#define  bead_select 242 /* position along the chain on which we apply the force */


#define fixed_bead   1  /* position fixed */
#define pulled_bead  383  /* position pulled */
...
#define ehi       0.1  /* 0.2  0.9  1.5  2.0   1.0 0.8;   energy scale for attract LJ pot */
#define eli       0.05 /* 0.1  1.0;                       energy scale for purely repulsive LJ pot. */
